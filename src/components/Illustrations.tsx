...
export function LoginPicture() {
  return (
    <div className="mx-auto w-[220px] bg-white rounded-lg border border-rule shadow-card p-4 text-center">
      <div className="text-[12px] font-bold">customer-credits</div>
      <div className="text-[11px] text-dim mt-0.5">Sign in to continue</div>
      <div className="mt-3 bg-ink text-white rounded-md py-1.5 text-[11px] font-semibold">Continue with harbor.co</div>
...
export function PermissionsPicture() {
  return (
    <div className="mx-auto w-[240px] bg-white rounded-lg border border-rule shadow-card p-4">
      <div className="text-[11px] text-dim mb-2">who can open supplier-payments</div>
...
export function LogPicture() {
  return (
    <div className="mx-auto w-[250px] bg-white rounded-lg border border-rule shadow-card p-3 font-mono text-[10.5px] leading-[18px]">
      <div><span className="text-dim">09:41:02</span> dana <span className="text-ok">opened</span> budget-lines</div>
      <div><span className="text-dim">09:42:05</span> priya <span className="text-bad">denied</span> nda-lookup</div>
...
export function ListPicture() {
  return (
    <div className="mx-auto w-[240px] bg-white rounded-lg border border-rule shadow-card p-3 text-[11px]">
      <div className="text-dim mb-1.5">15 apps · harbor.co</div>
      {[['customer-credits', 'Support'], ['budget-lines', 'Finance'], ['incident-handover', 'Engineering']].map(([n, t]) => (
