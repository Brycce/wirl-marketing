// The internal tools that show up across the page, and the team that can open each.
// A fictional company, acme.co, and its tools. None of these are anyone else's examples.
export const COMPANY = 'acme.co';
