...
export default function CopyButton({ text }: { text: string }) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-3 border border-gray-300 rounded-full px-5 py-3 text-sm font-mono text-gray-700 hover:border-gray-400 transition-colors cursor-pointer group"
    >
      <span className="text-gray-400">$</span>
      <span>npm install wirl</span>
      {copied ? (
