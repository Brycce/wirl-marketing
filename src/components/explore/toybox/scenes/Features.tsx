...
import { K, Win, Term, LinkBar, Btn, Hand, Avatar, AvatarStack, Harbor, GoogleG, Globe, Padlock, CheckBadge, DieCut,
  RoundSticker, NamedCursor, Sparkle, Stamp, CastShadow, MiniLock, Bars } from '../kit';
...
export function SigninScene() {
  return (
    <svg viewBox="0 0 560 500" className="tb-art" role="img" aria-label="A Google account chooser: Choose an account to continue to supplier-payments, with Priya Nair and Tom Abara at harbor.co. A hand taps Priya. A No invites sticker is slapped on the corner." strokeLinecap="round" strokeLinejoin="round">
      ...
      {/* No invites */}
      <DieCut tilt={9} cx={420} cy={104} cut={<rect x={344} y={78} width={152} height={52} rx={26} />} big>
        <rect x={344} y={78} width={152} height={52} rx={26} fill={K.sun} stroke={K.ink} strokeWidth={3} />
        ...
        <text x={392} y={110.5} fontSize={18} fontWeight={900} fill={K.ink}>No invites</text>
      </DieCut>
    </svg>
  );
}
...
export function OnlyScene() {
  return (
    <svg viewBox="0 0 560 500" className="tb-art" role="img" aria-label="A setting titled Who can open supplier-payments, set to Everyone at harbor.co, with Only these people and Anyone with the link as the other choices. Behind it, what someone outside Harbor sees at the same link: a big padlock and Only people at harbor.co can open this." strokeLinecap="round" strokeLinejoin="round">
      {/* The outsider's view */}
      <Win x={206} y={20} w={340} h={296} bar={K.edge} barH={44}>
        <LinkBar x={216} y={70} w={320} h={30} text={LINK} size={14} />
        <Padlock x={338} y={120} s={1.25} shackleClass="tb-rattle" />
        <text x={376} y={258} fontSize={16} fontWeight={800} fill={K.ink} textAnchor="middle">Only people at harbor.co</text>
        <text x={376} y={280} fontSize={16} fontWeight={800} fill={K.ink} textAnchor="middle">can open this.</text>
      </Win>
      <CastShadow x={16} y={150} w={330} h={326} r={20} dx={14} dy={16} />
      {/* The setting */}
      <g>
        <rect x={16} y={156} width={330} height={326} rx={20} fill={K.edge} stroke={K.ink} strokeWidth={3} />
        <rect x={16} y={150} width={330} height={326} rx={20} fill={K.paper} stroke={K.ink} strokeWidth={3} />
        <text x={38} y={190} fontSize={19} fontWeight={800} fill={K.ink}>Who can open</text>
        <text x={38} y={214} fontSize={19} fontWeight={800} fill={K.ink}>supplier-payments?</text>
        {/* Everyone at harbor.co (selected) */}
        <rect x={32} y={238} width={298} height={80} rx={16} fill={K.greenEdge} stroke={K.ink} strokeWidth={2.5} transform="translate(0 4)" />
        <rect x={32} y={238} width={298} height={80} rx={16} fill={K.green} stroke={K.ink} strokeWidth={2.5} />
        <g className="tb-only-check">
          <circle cx={58} cy={264} r={12} fill={K.paper} stroke={K.ink} strokeWidth={2.5} />
          <path d="M52.5 264.5 l3.6 3.6 l6.6 -7.2" fill="none" stroke={K.green} strokeWidth={3} />
        </g>
        <text x={80} y={270} fontSize={17} fontWeight={800} fill={K.paper}>Everyone at harbor.co</text>
        <AvatarStack x={92} y={296} r={11} who={['mia', 'sam', 'lena']} />
        <text x={136} y={301.5} fontSize={15} fontWeight={800} fill={K.paper}>+209</text>
        {/* Only these people */}
        <rect x={32} y={334} width={298} height={60} rx={16} fill={K.paper} stroke={K.ink} strokeWidth={2.5} />
        <circle cx={58} cy={364} r={11} fill={K.paper} stroke={K.ink} strokeWidth={2.5} />
        <text x={80} y={370} fontSize={17} fontWeight={800} fill={K.ink}>Only these people</text>
        <AvatarStack x={256} y={364} r={11} who={['priya', 'tom', 'lena']} step={16} />
        {/* Anyone with the link */}
        <rect x={32} y={404} width={298} height={60} rx={16} fill={K.wash} stroke="#B3AB98" strokeWidth={2.5} />
        <circle cx={58} cy={434} r={11} fill={K.wash} stroke="#B3AB98" strokeWidth={2.5} />
        <text x={80} y={440} fontSize={17} fontWeight={800} fill="#8A8474">Anyone with the link</text>
        <Globe x={302} y={434} r={9} color="#8A8474" />
      </g>
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 560 500" className="tb-art" role="img" aria-label="A browser at app.wirl.dev titled Keys, supplier-payments: a STRIPE_KEY field full of dots, a Save to vault button, and a Saved to vault toast. Behind it, the code only names env.STRIPE_KEY, and the agent's terminal wears a sticker: Agent never sees it." strokeLinecap="round" strokeLinejoin="round">
      ...
      <Win x={14} y={30} w={300} h={130} barH={34} bar={K.edge}>
        <text className="mono" x={74} y={52.5} fontSize={14} fill={K.ink}>pay.ts</text>
        <text className="mono" x={30} y={88} fontSize={14.5} fill={K.ink}><tspan fill="#8E7CF0">const</tspan> stripe =</text>
        <rect x={132} y={100} width={126} height={24} rx={6} fill={K.sun} />
      ...
      {/* The agent */}
      <Term x={340} y={24} w={206} h={170} barH={34}>
        <text x={398} y={46} fontSize={14} fill={K.termText}>Agent</text>
        <Bars x={358} y={78} widths={[120, 150, 90, 130]} gap={20} h={8} fill="#44544B" />
      </Term>
      <LogoSticker agent="claude" x={380} y={41} size={22} uid="keys-term" />
      <RoundSticker
        x={500}
        y={176}
        r={44}
        ...
        face={
          <g>
            <circle r={43} fill={K.lilac} stroke={K.ink} strokeWidth={3} />
            <g transform="translate(0 -21)" fill="none" stroke={K.ink} strokeWidth={2.4}>
              <path d="M-11 0 Q0 -9 11 0 Q0 9 -11 0 Z" fill={K.paper} />
              <circle r={3.4} fill={K.ink} />
              <path d="M-12 8 L12 -8" stroke={K.tomato} strokeWidth={3} />
            </g>
            <text x={0} y={2} fontSize={14} fontWeight={900} fill={K.ink} textAnchor="middle">AGENT</text>
            <text x={0} y={18} fontSize={14} fontWeight={900} fill={K.ink} textAnchor="middle">NEVER</text>
            <text x={0} y={34} fontSize={14} fontWeight={900} fill={K.ink} textAnchor="middle">SEES IT</text>
          </g>
        }
      />
      {/* The vault form */}
...
export function RollbackScene() {
  ...
  return (
    <svg viewBox="0 0 600 400" className="tb-art" role="img" aria-label="Two versions of supplier-payments. The new v4 throws 500 errors and is stamped ROLLED BACK; a big arrow swings back to v3, which wears the Live badge." strokeLinecap="round" strokeLinejoin="round">
...
export function ShareScene() {
  return (
    <svg viewBox="0 0 600 520" className="tb-art" role="img" aria-label="Priya copies the link to supplier-payments v4. In Tom's terminal: npx wirl pull supplier-payments, pulled v4, npx wirl dev. Then v5 of the same app, with one new Export CSV button that Tom added." strokeLinecap="round" strokeLinejoin="round">
      ...
      <NamedCursor x={120} y={206} who="priya" s={0.9} />
      {/* Tom's terminal */}
      ...
      {/* v5, one new button */}
      <MiniApp x={296} y={300} v="v5" extra />
      <g className="tb-sh-sparks">
        <Sparkle x={432} y={436} r={11} />
        <Sparkle x={582} y={470} r={9} />
        <Sparkle x={590} y={430} r={6} />
      </g>
      <NamedCursor x={530} y={478} who="tom" />
    </svg>
  );
}
